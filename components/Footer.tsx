...
const Footer = () => {
  return (
    <footer className="border-t border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 px-6 py-12 lg:px-8 transition-colors">
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-8 lg:grid-cols-4">
          ...
          {/* Produk Links */}
          <div>
            <h4 className="mb-4 text-gray-900 dark:text-zinc-100">Produk</h4>
          ...
          {/* Kontak Links */}
          <div>
            <h4 className="mb-4 text-gray-900 dark:text-zinc-100">Kontak</h4>
            <ul className="space-y-2 text-gray-600 dark:text-zinc-400">
              {[
                "Tentang Kami",
                "Hubungi Kami",
        ...
        {/* Bottom */}
        <div className="mt-12 border-t border-gray-200 dark:border-zinc-800 pt-8 text-center text-gray-600 dark:text-zinc-400">
